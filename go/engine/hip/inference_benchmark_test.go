...
func inferenceBenchmarkHIPKernelTensorShape(config hipKernelLaunchConfig) (rows, cols, group, batch uint32) {
	...
	case hipKernelNameAttentionHeadsBatchChunkedStage1, hipKernelNameAttentionHeadsBatchChunkedStage1GQA2, hipKernelNameAttentionHeadsBatchChunkedStage1GQA4, hipKernelNameAttentionHeadsBatchChunkedStage1GQA8, hipKernelNameAttentionHeadsBatchChunkedStage2:
