...
var productionQuantizationPackSupport = []ProductionQuantizationPackSupport{
	...
	{Name: "bf16", Size: "E2B", ModelID: "mlx-community/gemma-4-e2b-it-bf16", Bits: 16, QuantMode: "bf16", Runtime: RuntimeBF16, GenerateStatus: GenerateLinked, ProductRole: "quality-control", Supported: true, RunnableOnCard: true, RequiresBench: true, RequiresNative: true},
	{Name: "e4b-bf16", Size: "E4B", ModelID: "mlx-community/gemma-4-e4b-it-bf16", Bits: 16, QuantMode: "bf16", Runtime: RuntimeBF16, GenerateStatus: GenerateLinked, ProductRole: "quality-control", Supported: true, RunnableOnCard: true, RequiresBench: true, RequiresNative: true},
	...
	{Name: "26b-a4b-4bit", Size: "26B-A4B", ModelID: "lmstudio-community/gemma-4-26B-A4B-it-MLX-4bit", Bits: 4, QuantMode: "q4", Runtime: RuntimeMLXAffine, GenerateStatus: GenerateLinked, ProductRole: "host-offload", Supported: true, RunnableOnCard: true, RequiresBench: true},
