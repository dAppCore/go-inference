...
func TestNormalizeWeights_CheckpointIndexNames_Good(t *testing.T) {
...
func TestNormalizeWeights_CheckpointIndexNames_Bad(t *testing.T) {
	if len(NormalizeWeights(nil)) != 0 {
		t.Fatal("nil changed")
	}
}
func TestNormalizeWeights_CheckpointIndexNames_Ugly(t *testing.T) {
