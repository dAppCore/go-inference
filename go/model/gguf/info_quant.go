...
var ggufTensorTypeDetailsTable = [41]ggufTensorTypeDetailsInfo{
	TensorTypeF32:          {Name: "f32", DType: "float32", Bits: 32, Known: true},
	...
	TensorTypeQ2K:          {Name: "q2_k", DType: "ggml_q2_k", Bits: 2, BlockSize: 256, Quantized: true, Known: true},
	TensorTypeQ3K:          {Name: "q3_k", DType: "ggml_q3_k", Bits: 3, BlockSize: 256, Quantized: true, Known: true},
	TensorTypeQ4K:          {Name: "q4_k", DType: "ggml_q4_k", Bits: 4, BlockSize: 256, Quantized: true, Known: true},
	TensorTypeQ5K:          {Name: "q5_k", DType: "ggml_q5_k", Bits: 5, BlockSize: 256, Quantized: true, Known: true},
	TensorTypeQ6K:          {Name: "q6_k", DType: "ggml_q6_k", Bits: 6, BlockSize: 256, Quantized: true, Known: true},
	...
	TensorTypeBF16:         {Name: "bf16", DType: "bfloat16", Bits: 16, Known: true},
