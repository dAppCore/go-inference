...
// and dtype — NormalizeWeights' own decode of a real checkpoint always produces that; a mismatch means a
// malformed/partial checkpoint or a hand-built input, reported by the exact tensor name that broke the
// pattern.
