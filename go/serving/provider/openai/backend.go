...
func (m *Model) complete(ctx context.Context, messages []inference.Message, opts ...inference.GenerateOption) core.Result {
	...
	response := responseResult.Value.(ChatCompletionResponse)
	metrics := inference.GenerateMetrics{
...
func (m *Model) doRequest(ctx context.Context, req ChatCompletionRequest) core.Result {
...
func openaiMessages(messages []inference.Message) []ChatMessage {
...
func chatCompletionsURL(baseURL string) string {
	...
	return trimTrailingSlash(baseURL) + DefaultChatCompletionsPath
}
