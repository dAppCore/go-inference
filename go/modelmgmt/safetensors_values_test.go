...
func TestSafetensorsValues_DecodeFloat32_F16(t *core.T) {
...
func TestSafetensorsValues_DecodeFloat32_F16_Subnormal(t *core.T) {
...
func TestSafetensorsValues_DecodeFloat32_F16_LengthMismatch(t *core.T) {
	_, err := DecodeFloat32("F16", []byte{0}, 1)
	core.AssertErrorIs(t, err, errDecodeF16PayloadMismatch)
}

func TestSafetensorsValues_DecodeFloat32_BF16(t *core.T) {
...
func TestSafetensorsValues_DecodeFloat32_BF16_LengthMismatch(t *core.T) {
	_, err := DecodeFloat32("BF16", []byte{0}, 1)
	core.AssertErrorIs(t, err, errDecodeBF16PayloadMismatch)
}

func TestSafetensorsValues_DecodeFloat32_F64(t *core.T) {
...
func TestSafetensorsValues_DecodeFloat32_F64_LengthMismatch(t *core.T) {
