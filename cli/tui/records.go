...
// The ORM's NotNull constraint also rejects empty strings. Apply it only to
// fields that must be non-empty; the migration separately gives every column
// SQL NOT NULL semantics, where an empty optional text value remains valid.
...
func (sessionRecord) Schema() orm.Schema {
	return orm.Define(func(builder *orm.Builder) {
		...
		builder.String("preferred_model")
...
func (turnRecord) Schema() orm.Schema {
	return orm.Define(func(builder *orm.Builder) {
		...
		builder.String("visible")
		builder.String("thought")
		builder.String("tool_name")
		builder.String("tool_call_json")
		builder.String("tool_result_json")
...
func (eventRecord) Schema() orm.Schema {
	return orm.Define(func(builder *orm.Builder) {
		...
		builder.String("id").NotNull()
		builder.String("session_id").NotNull()
		builder.String("work_item_id")
		builder.String("job_id")
		builder.String("kind").NotNull()
		builder.String("status").NotNull()
		builder.String("title").NotNull()
		builder.String("detail")
		builder.String("payload_json")
		builder.Time("created_at").NotNull()
...
func (generationJobRecord) Schema() orm.Schema {
	return orm.Define(func(builder *orm.Builder) {
		...
		builder.String("id").NotNull()
		builder.String("session_id").NotNull()
		builder.String("prompt_turn_id")
		builder.String("answer_turn_id")
		builder.String("status").NotNull()
		builder.String("model")
		builder.String("error")
		builder.String("metrics_json")
		builder.Time("created_at").NotNull()
...
func (workItemRecord) Schema() orm.Schema {
	return orm.Define(func(builder *orm.Builder) {
		...
		builder.String("title").NotNull()
		builder.String("status").NotNull()
		builder.String("agent")
		builder.String("repo")
		builder.String("org")
		builder.String("task")
		builder.String("branch")
		builder.String("runtime")
		builder.String("question")
		builder.String("pr_url")
		builder.String("session_id")
		builder.Time("started_at").NotNull()
		builder.Time("updated_at").NotNull()
		builder.Bool("archived").NotNull()
		builder.Time("archived_at").NotNull()
...
func (attachmentRecord) Schema() orm.Schema {
	return orm.Define(func(builder *orm.Builder) {
		...
		builder.String("title").NotNull()
		builder.String("content_hash")
		builder.String("snapshot")
